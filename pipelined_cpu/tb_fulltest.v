// tb_fulltest.v — wrapper for RV32I full test
`timescale 1ns/1ps
module testbench;
    parameter MEMFILE = "fulltest.txt";
    parameter ANSFILE = "fulltest_ans.txt";
    parameter EXP_NUM = 39;
    ...
    initial begin
        ...
        $dumpfile("tb_fulltest.vcd"); $dumpvars(0,testbench);
        #30; reset=0;
        $display("===== RV32I FULL TEST =====");
